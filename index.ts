    ...
    return new Promise<void>((resolve, reject) => {
        ffmpeg()
            ...
            .complexFilter([
                ...
                `colorkey=color=${color}:similarity=${similarity}:blend=${blend},scale=800:800:force_original_aspect_ratio=decrease,pad=800:800:(ow-iw)/2:(oh-ih)/2:color=black@0,loudnorm=I=-12:LRA=11:TP=-9`,
            ])
